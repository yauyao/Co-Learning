...
@SuppressLint("NewApi")
public class Elementary extends ListFragment {
    
	private static final String TAG = "Elementayr";
    ...
    private void queryAndPrintActionLogs() {
    	try {
    		...
    		Cursor cursor = db.rawQuery("select * from word_information where level = 1 or level = 2", null);
